package com.veisite.vegecom.util.export;
...
public class TableExporter {
	...
	public static final Logger logger = LoggerFactory.getLogger(TableExporter.class);
	...
	public TableExporter(int format) throws IllegalArgumentException {
		checkFormat(format);
		this.format = format;
	}
